...
// Hack to only one custom post type:
// 	var $post_types = 'frontpageslide';
// Hack to use more than one custom post type:
// 	var $post_types = array('matchup', 'event');
// Hack to use 'clip' custom post type
	var $post_types = array('clip');
// Original code:
//	var $post_types = null;
// End hack
